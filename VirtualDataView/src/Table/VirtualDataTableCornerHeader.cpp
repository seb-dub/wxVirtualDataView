/**********************************************************************/
/** FILE    : VirtualDataTableCornerHeader.cpp                       **/
...
const char wxVDVCornerHeaderNameStr[] = "wxVirtualDataTableCornerHeader";

//----------------- CONSTRUCTORS & DESTRUCTOR -----------------------//
/** Default constructor
  */
wxVirtualDataTableCornerHeader::wxVirtualDataTableCornerHeader(void)
    : wxVirtualHeaderCtrl(),
...
/** Constructor
  ...
  */
wxVirtualDataTableCornerHeader::wxVirtualDataTableCornerHeader(wxWindow *pParent,
                                                               wxWindowID id,
                                                               const wxPoint &ptPos,
                                                               const wxSize &size,
                                                               long lStyle,
...
/** Get the owner window
  ...
  */
wxVirtualDataTableCtrl* wxVirtualDataTableCornerHeader::GetOwner(void) const
{
    return(m_pOwner);
}
...
/** Set the owner window
  ...
  */
void wxVirtualDataTableCornerHeader::SetOwner(wxVirtualDataTableCtrl* pOwner)
{
    m_pOwner = pOwner;
}
...
/** Get the amount of items in the header
  ...
  */
size_t wxVirtualDataTableCornerHeader::GetItemCount(void) const
{
    return(0);
}
...
/** Get the size of one item
  ...
  */
wxSize wxVirtualDataTableCornerHeader::GetItemSize(size_t uiItemID) const
{
...
/** Get the item data (label, sorting arrow, styles)
  ...
  */
bool wxVirtualDataTableCornerHeader::GetItemData(size_t uiItemID, TItemData &rData) const
{
    return(false);
}
...
/** Get the index of the 1st visible item
  ...
  */
size_t wxVirtualDataTableCornerHeader::GetFirstVisibleItem(void) const
{
    return(s_uiNotFound);
}
...
/** Get the index of the last visible item
  ...
  *         s_uiNotFound if there are no visible items
  */
size_t wxVirtualDataTableCornerHeader::GetNextVisibleItem(size_t uiItemID) const
{
    return(s_uiNotFound);
}
...
/** Get the last visible item
  ...
  *         s_uiNotFound if there are no visible items
  */
size_t wxVirtualDataTableCornerHeader::GetLastVisibleItem(void) const
{
    return(s_uiNotFound);
}
...
/** Get the origin of the 1st visible item (unscrolled coordinate)
  ...
  */
wxCoord wxVirtualDataTableCornerHeader::GetFirstItemOrigin(void) const
{
    return(0);
}
