/**********************************************************************/
/** FILE    : VirtualDataViewDateTimeRenderer.h                      **/
...
#ifndef _VIRTUAL_DATA_VIEW_DATE_TIME_RENDERER_H_
#define _VIRTUAL_DATA_VIEW_DATE_TIME_RENDERER_H_

#include <wx/VirtualDataView/Renderers/VirtualDataViewTextRenderer.h>

/** \class wxVirtualDataViewDateTimeRenderer : a date/time renderer for wxVirtualDataViewCtrl
  */
class WXDLLIMPEXP_VDV wxVirtualDataViewDateTimeRenderer: public wxVirtualDataViewTextRenderer
{
    public:
        //constructors & destructor
        wxVirtualDataViewDateTimeRenderer(bool bISOFormat = true,
        ...
        virtual ~wxVirtualDataViewDateTimeRenderer(void);                           ///< \brief destructor
