/**********************************************************************/
/** FILE    : VirtualDataViewBitmapTextRenderer.h                    **/
...
#ifndef _VIRTUAL_DATA_VIEW_BITMAP_TEXT_RENDERER_H_
#define _VIRTUAL_DATA_VIEW_BITMAP_TEXT_RENDERER_H_

#include <wx/VirtualDataView/Renderers/VirtualDataViewRenderer.h>

/** \class wxVirtualDataViewBitmapTextRenderer : a bitmap + text renderer for wxVirtualDataViewCtrl
  */
class WXDLLIMPEXP_VDV wxVirtualDataViewBitmapTextRenderer: public wxVirtualDataViewRenderer
{
    public:
        //constructors & destructor
        wxVirtualDataViewBitmapTextRenderer(EEllipsizeMode eMode = WX_ELLIPSIZE_NONE,
                                      EHAlign eHAlign = WX_HORIZ_ALIGN_LEFT,
                                      EVAlign eVAlign = WX_VERT_ALIGN_CENTRE);      ///< \brief default constructor
        virtual ~wxVirtualDataViewBitmapTextRenderer(void);                         ///< \brief destructor
