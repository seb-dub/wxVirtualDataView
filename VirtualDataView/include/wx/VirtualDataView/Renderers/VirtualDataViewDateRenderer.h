/**********************************************************************/
/** FILE    : VirtualDataViewDateRenderer.h                          **/
...
#ifndef _VIRTUAL_DATA_VIEW_DATE_RENDERER_H_
#define _VIRTUAL_DATA_VIEW_DATE_RENDERER_H_

#include <wx/VirtualDataView/Renderers/VirtualDataViewTextRenderer.h>

/** \class wxVirtualDataViewTextRenderer : a date renderer for wxVirtualDataViewCtrl
  */
class WXDLLIMPEXP_VDV wxVirtualDataViewDateRenderer: public wxVirtualDataViewTextRenderer
{
    public:
        //constructors & destructor
        wxVirtualDataViewDateRenderer(bool bISOFormat = true,
        ...
        virtual ~wxVirtualDataViewDateRenderer(void);                               ///< \brief destructor
